# Generated by Django 2.1.8 on 2019-07-22 06:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='StoreApp.Goods', verbose_name='商品id')),
            ],
        ),
        migrations.CreateModel(
            name='Seller',
        ...
        migrations.AddField(
            model_name='store',
            name='type',
            field=models.ManyToManyField(to='StoreApp.StoreType', verbose_name='店铺类型多对多'),
        ),
        migrations.AddField(
            model_name='goods',
            name='store_id',
            field=models.ManyToManyField(to='StoreApp.Store', verbose_name='商品店铺多对多'),
        ),
    ]
